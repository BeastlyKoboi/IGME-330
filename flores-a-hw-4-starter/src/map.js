...
const accessToken = "pk.eyJ1IjoiYmVhc3RseWtvYm9pIiwiYSI6ImNsb3g4c250ZDAwd3kya3JvZnI2YjBqd3EifQ.aBenoLkXcvaQ3pTuruoxGw";
let map;
...
const addMarker = (feature, className, clickHandler) => {
	// A. Create a map marker using feature (i.e.)
	// - the marker is a <div>
...
const addMarkersToMap = (json, clickHandler) => {
	...
	// loop through the features array and for each on add a marker to the map 
